...
write_clustering(f"output/lib-dinuc-{diseq}-{rmsd_threshold}.clust", clustering_closest)
write_clustering(f"output/lib-dinuc-{diseq}-{rmsd_threshold}.all.clust", clustering_all)
